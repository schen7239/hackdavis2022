...
export function RadioButtonsGroup({ question, inputArray, setFunction }) {
  return (
    <FormControl>
      <FormLabel className="text-xl mb-4" id="demo-radio-buttons-group-label">{question}</FormLabel>
      <RadioGroup
        ...
        <div className="col-span-9 p-10 w-full">
          ...
          <div className="grid justify-center mt-10 space-y-4">
            ...
            <div className="bg-white p-10 w-[60rem] rounded-lg space-y-2">
              ...
              <button onClick={search} className="bg-primary-blue content-center p-4 rounded-full text-white text-semibold active:scale-90 transition duration-150 ease-out">Submit Now</button>
          </div>
        </div>
      </div>
    </>
