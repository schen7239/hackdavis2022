    ...
    <div className="grid grid-cols-10 h-[100vh]">
      ...
      <div className="col-span-9 p-10 w-full">
        ...
        <h2 className="font-light text-sm text-gray-400">
          You have been paired with 4 recommended mentors. Chat with a couple to establish
          your best fit!
        </h2>
        <div className="grid grid-cols-2 text-center justify-center items-center"></div>
      </div>
    </div>
  );
}
