        ...
        <div className="grid grid-cols-5 bg-white p-4 rounded-xl shadow-md">
          <div className="col-span-2 bg-[#F5F5F5] rounded-xl py-5">
              <Tabs className="h-12 w-full" >
                <TabList className="flex space-x-2 justify-around items-center text-sm" >
                  <Tab selectedClassName="outline-none underline decoration-4 underline-offset-8 decoration-primary-blue" >Total Exercises</Tab>
                  <Tab selectedClassName="outline-none underline decoration-4 underline-offset-8 decoration-primary-blue">In-Progress</Tab>
                  <Tab selectedClassName="outline-none underline decoration-4 underline-offset-8 decoration-primary-blue">Completed</Tab>
                </TabList>
                <div className="p-8" >
                <TabPanel>
                  <div className="space-y-8 text-sm">
                    ...
                    <h2>New soft skill achievements over 2 weeks: <span className="text-primary-blue">3</span></h2>
                  </div>
                </TabPanel>
                <TabPanel>
                  <h2>Any content 2</h2>
          ...
          <div className="col-span-3 pl-10 w-full">
            {exerciseProgress?.map(({exercise, percentCompleted}) => (
              <div key={exercise} className="w-full flex items-center space-x-6 bg-[#F5F5F5] mb-4 p-4 rounded-xl" >
                <Icon icon="bi:play-circle-fill" width={40} height={40} className="text-primary-blue" />
